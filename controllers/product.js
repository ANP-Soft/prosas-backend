...
const newProduct = async (req = request, res = response) => {
    ...
    const { status, user, sku, ...body } = req.body; //en body: name, category, price, description, stock, img, lastModified
...
const updateProduct = async (req = request, res = response) => {
    ...
    const { id } = req.params;
    const { status, user, sku, ...body } = req.body; //en body: name, category, price, description, stock, img, lastModified //no se actualiza ni status ni user introducido por REQUEST
